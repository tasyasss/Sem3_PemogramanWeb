...
echo "Daftar karyawan yang memiliki pengalaman 
lebih dari 5 tahun: " . implode(", ", $karyawanPengalamanLimaTahun);
...
$total = 0;
foreach ($daftarSiswa as $mhs) {
    $total += $mhs[1];
    $avg = $total / count($daftarSiswa);
}
